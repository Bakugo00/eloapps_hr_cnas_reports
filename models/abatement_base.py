...
class AbatementBase(models.Model):
    _name = "abatement.base"
    _description = "Assiette d'abattement"

    employee_id = fields.Many2one("hr.employee", "Nom & Prénom")
    name = fields.Char("Numéro", related= 'employee_id.sec_social')
    ...
    abatement40_id = fields.Many2one('declaration.cotisation', string='Abattement 40%')
    abatement80_id = fields.Many2one('declaration.cotisation', string='Abattement 80%')
    abatement90_id = fields.Many2one('declaration.cotisation', string='Abattement 90%')

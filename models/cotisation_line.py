...
class DeclarationCotisationLine(models.Model):
    _name = "cotisation.line"

    line_cotisation_id = fields.Many2one('declaration.cotisation', string='Décalration de cotisation')
